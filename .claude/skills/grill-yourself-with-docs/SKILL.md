...
**never** Edit / Write / NotebookEdit a source file. The settled design is still a plan,
...
and ADRs (`docs/adr/`) — and that you did NOT Edit / Write / NotebookEdit any source file
